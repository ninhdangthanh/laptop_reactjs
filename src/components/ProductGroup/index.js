...
function ProdGroup(props) {
  ...
  const dellList = [listProducts[22], listProducts[23], listProducts[24]];

  const HPList = [listProducts[16], listProducts[11], listProducts[15]];

  const macbookList = [listProducts[1], listProducts[2], listProducts[3]];

  const thinkpadList = [listProducts[7], listProducts[6], listProducts[9]];
