...
class Header extends Component {
  ...
  toggleCartTable = () => {
    if (this.props.isLocal) {
      this.props.toggleCartTable();
    } else {
      toastWarning("Đăng nhập để mở giỏ hàng");
    }
    let detailUser = JSON.parse(localStorage.getItem("NinhNamUser"));
    if (detailUser) {
      if (detailUser.cartProduct.length === 0) {
        toastWarning("Giỏ hàng chưa có sản phẩm");
      }
    }
  };
          ...
          <Grid alignItems="center" spacing={4} container>
            ...
            <Grid item xs={3}>
              <div className="header__search">
                ...
                />
                <FontAwesomeIcon onClick={this.fowSearchPage} className="icon" icon={faSearch} />
              </div>
            </Grid>
            <Grid item xs={3}>
              ...
              <div className="header__extension">
                ...
                <div className="header__extension-item col">
                  ...
                  >
                    ...
                    <div className="userID">ID: {this.state.userApp.id}</div>
